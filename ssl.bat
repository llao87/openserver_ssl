...
set OPENSSL_CONF=C:\OpenServer\modules\http\Apache_2.4-PHP_7.2-7.4\conf\openssl.cnf
PATH=%PATH%;C:\OpenServer\modules\http\Apache_2.4-PHP_7.2-7.4\bin
